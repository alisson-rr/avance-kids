...
Preencha este bloco ao adotar o template:

- Nome: `<nome-do-projeto>`
- Objetivo: `<problema que o projeto resolve>`
- Stack: `<linguagens, frameworks e serviços>`
- Arquitetura: `<módulos e limites principais>`
- Fonte de verdade das tarefas: `<issue tracker, kanban ou arquivo>`
- Instalar: `<comando>`
- Desenvolver: `<comando>`
- Validar: `<lint, tipos, testes e build>`

Se um campo continuar como placeholder, descubra o valor nos arquivos do projeto. Não invente comandos nem instale dependências para preencher lacunas.
